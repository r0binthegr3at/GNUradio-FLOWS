...
# Title: REPLAY
# Author: merlin
# Description: Basic Replay attack
...
class REPLAY(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.main_freq = main_freq = 433e6
        ...
        self.osmosdr_source_0.set_center_freq(main_freq, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_0.set_frequency_range(self.main_freq, self.samp_rate)
    ...
    def set_main_freq(self, main_freq):
        ...
        self.osmosdr_source_0.set_center_freq(self.main_freq, 0)
        self.qtgui_sink_x_0.set_frequency_range(self.main_freq, self.samp_rate)
