...
class hackrf_basic(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "basic_hackrf", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("basic_hackrf")
        ...
        self.settings = Qt.QSettings("GNU Radio", "hackrf_basic")
        ...
        self.center_freq = center_freq = 314.359e6
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'rolling_demod', False)
...
def main(top_block_cls=hackrf_basic, options=None):
